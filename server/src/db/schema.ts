...
export const books = pgTable("books",
    {
        ...
        categoryId: uuid("category_id")
            .references(() => bookCategories.id, { onDelete: "set null" }),
...
export const bookmarks = pgTable(
    ...
    (table) => [
        uniqueIndex("bookmarks_user_book_unique").on(
            table.userId,
            table.bookId
        ),
    ]
...
export const reviews = pgTable(
    ...
    (table) => [
        ...
        uniqueIndex("reviews_user_book_unique").on(
            table.userId,
            table.bookId
        ),
    ]
...
export const carts = pgTable(
    ...
    (table) => [
        ...
        uniqueIndex("carts_user_book_unique").on(
            table.userId,
            table.bookId
        ),
    ]
...
export const vouchers = pgTable("vouchers",
    {
        ...
        voucherTypeId: uuid("voucher_type_id")
            .references(() => voucherTypes.id, { onDelete: "restrict" }),
    ...
    (table) => [
        ...
        check("vouchers_start_date_check", sql`${table.startDate} < ${table.endDate}`),
    ]
);
...
export const transactionHistories = pgTable("transaction_histories",
    ...
    (table) => [
        ...
        check("transaction_histories_total_discount_check", sql`${table.totalDiscount} >= 0`),
        check("transaction_histories_total_amount_check", sql`${table.totalAmount} > 0`),
    ]
);
